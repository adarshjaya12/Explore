...
namespace Explore.BusinessObj.Implementation.Service
{
    public class GoogleAPI :IGoogleAPI
    {
        ...
        {
            get { return "place/details/json?placeid={0}&key=AIzaSyCBSvM5VkXIPQ8qATe-DewVCnOPAg1LfzQ"; }
        }
        ...
        {
            get { return "place/nearbysearch/json?location={0}&radius=5000&type={1}&rankby=prominence&key=AIzaSyCBSvM5VkXIPQ8qATe-DewVCnOPAg1LfzQ&pagetoken={2}"; }
        }
